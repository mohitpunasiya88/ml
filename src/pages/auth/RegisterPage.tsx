...
import { FolderSync, User, Mail, Lock, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-sm border border-gray-200">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Register to access ML Project Monitoring System</p>
        </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  type="text"
                  autoComplete="name"
                  className={`pl-10 input ${errors.name ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  id="confirmPassword"
                  type="password"
                  className={`pl-10 input ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}`}
